export const QUESTIONS = [
  ...
  },
  {
    ...
    question: 'How many hours will I dedicate to the classes, homework and internship?',
    answer: [
      {
        type: 'paragraph',
  ...
  {
    type: 'Programme conditions',
    question: "Can I start by studying/working remotely if I'm not able to be physically present?",
    answer: [
      {
        type: 'paragraph',
